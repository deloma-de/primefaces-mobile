...
public class MobileUtils {
    ...
    /**
     * Retrieve mobile theme from init params
     * 
     * @param externalContext
     * 
     * @return
     */
    public static String getTheme(ExternalContext externalContext)
    {
    	return externalContext.getInitParameter(MobileConstants.ContextParams.MOBILE_THEME);
    }
}
