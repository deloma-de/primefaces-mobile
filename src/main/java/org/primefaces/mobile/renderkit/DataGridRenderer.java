...
public class DataGridRenderer extends org.primefaces.component.datagrid.DataGridRenderer {
    ...
    protected void encodeMarkup(FacesContext context, DataGrid grid) throws IOException {
        ...
        String styleClass = grid.getStyleClass() == null ? MOBILE_DATAGRID_CLASS : MOBILE_DATAGRID_CLASS + " " + grid.getStyleClass();
        String contentClass;
        
        PaginatorRenderer paginatorRenderer = getPaginatorRenderer(context);
        
        if(empty) {
            contentClass = MOBILE_EMPTY_CONTENT_CLASS;
        }
        else {
            contentClass = MOBILE_CONTENT_CLASS;
        ...
        encodeFacet(context, grid, "header", MOBILE_HEADER_CLASS);
        ...
        encodeFacet(context, grid, "footer", MOBILE_FOOTER_CLASS);
